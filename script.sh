...
echo "DOMAIN_NAME=dimasik99.42.fr" > project/srcs/.env
echo "CERT_=./requirements/tools/dimasik99.42.fr.crt" >> project/srcs/.env
echo "KEY_=./requirements/tools/dimasik99.42.fr.key" >> project/srcs/.env
